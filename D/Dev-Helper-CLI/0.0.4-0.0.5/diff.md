# Comparing `tmp/Dev-Helper-CLI-0.0.4.tar.gz` & `tmp/Dev-Helper-CLI-0.0.5.tar.gz`
...
## Comparing `Dev-Helper-CLI-0.0.4.tar` & `Dev-Helper-CLI-0.0.5.tar`
...
### Comparing `Dev-Helper-CLI-0.0.4/Dev_Helper_CLI.egg-info/PKG-INFO` & `Dev-Helper-CLI-0.0.5/Dev_Helper_CLI.egg-info/PKG-INFO`
...
### Comparing `Dev-Helper-CLI-0.0.4/LICENSE` & `Dev-Helper-CLI-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `Dev-Helper-CLI-0.0.4/PKG-INFO` & `Dev-Helper-CLI-0.0.5/PKG-INFO`
...
### Comparing `Dev-Helper-CLI-0.0.4/dh/backend/document_db.py` & `Dev-Helper-CLI-0.0.5/dh/backend/document_db.py`

 * *Files identical despite different names*

### Comparing `Dev-Helper-CLI-0.0.4/dh/backend/validations.py` & `Dev-Helper-CLI-0.0.5/dh/backend/validations.py`

 * *Files identical despite different names*

### Comparing `Dev-Helper-CLI-0.0.4/dh/cli.py` & `Dev-Helper-CLI-0.0.5/dh/cli.py`
...
### Comparing `Dev-Helper-CLI-0.0.4/setup.py` & `Dev-Helper-CLI-0.0.5/setup.py`
