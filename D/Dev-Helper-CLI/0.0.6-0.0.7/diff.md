# Comparing `tmp/Dev-Helper-CLI-0.0.6.tar.gz` & `tmp/Dev-Helper-CLI-0.0.7.tar.gz`
...
## Comparing `Dev-Helper-CLI-0.0.6.tar` & `Dev-Helper-CLI-0.0.7.tar`
...
### Comparing `Dev-Helper-CLI-0.0.6/Dev_Helper_CLI.egg-info/PKG-INFO` & `Dev-Helper-CLI-0.0.7/Dev_Helper_CLI.egg-info/PKG-INFO`
...
### Comparing `Dev-Helper-CLI-0.0.6/LICENSE` & `Dev-Helper-CLI-0.0.7/LICENSE`

 * *Files identical despite different names*

### Comparing `Dev-Helper-CLI-0.0.6/PKG-INFO` & `Dev-Helper-CLI-0.0.7/PKG-INFO`
...
### Comparing `Dev-Helper-CLI-0.0.6/dh/backend/document_db.py` & `Dev-Helper-CLI-0.0.7/dh/backend/document_db.py`

 * *Files identical despite different names*

### Comparing `Dev-Helper-CLI-0.0.6/dh/backend/validations.py` & `Dev-Helper-CLI-0.0.7/dh/backend/validations.py`

 * *Files identical despite different names*

### Comparing `Dev-Helper-CLI-0.0.6/dh/cli.py` & `Dev-Helper-CLI-0.0.7/dh/cli.py`
...
### Comparing `Dev-Helper-CLI-0.0.6/setup.py` & `Dev-Helper-CLI-0.0.7/setup.py`
