# Comparing `tmp/volttron_dnp3_outstation-0.1.1a5.tar.gz` & `tmp/volttron_dnp3_outstation-0.1.1a6.tar.gz`
...
+gzip compressed data, was "volttron_dnp3_outstation-0.1.1a6.tar", max compression
```

## Comparing `volttron_dnp3_outstation-0.1.1a5.tar` & `volttron_dnp3_outstation-0.1.1a6.tar`
...
+-rw-r--r--   0        0        0    11927 2023-05-12 18:36:51.825998 volttron_dnp3_outstation-0.1.1a6/LICENSE
+-rw-r--r--   0        0        0    17123 2023-05-12 18:36:51.825998 volttron_dnp3_outstation-0.1.1a6/README.md
+-rw-r--r--   0        0        0     2004 2023-05-12 18:38:11.019242 volttron_dnp3_outstation-0.1.1a6/pyproject.toml
+-rw-r--r--   0        0        0        0 2023-05-12 18:36:51.825998 volttron_dnp3_outstation-0.1.1a6/src/dnp3_outstation/__init__.py
+-rw-r--r--   0        0        0    10014 2023-05-12 18:36:51.825998 volttron_dnp3_outstation-0.1.1a6/src/dnp3_outstation/agent.py
+-rw-r--r--   0        0        0        0 2023-05-12 18:36:51.825998 volttron_dnp3_outstation-0.1.1a6/src/vdnp3_outstation/__init__.py
+-rw-r--r--   0        0        0       89 2023-05-12 18:36:51.825998 volttron_dnp3_outstation-0.1.1a6/src/vdnp3_outstation/__main__.py
+-rw-r--r--   0        0        0    10858 2023-05-12 18:36:51.825998 volttron_dnp3_outstation-0.1.1a6/src/vdnp3_outstation/run_volttron_dnp3_outstation_cli.py
+-rw-r--r--   0        0        0    18709 1970-01-01 00:00:00.000000 volttron_dnp3_outstation-0.1.1a6/setup.py
+-rw-r--r--   0        0        0    18491 1970-01-01 00:00:00.000000 volttron_dnp3_outstation-0.1.1a6/PKG-INFO
```

### Comparing `volttron_dnp3_outstation-0.1.1a5/LICENSE` & `volttron_dnp3_outstation-0.1.1a6/LICENSE`

 * *Files identical despite different names*

### Comparing `volttron_dnp3_outstation-0.1.1a5/README.md` & `volttron_dnp3_outstation-0.1.1a6/README.md`

 * *Files identical despite different names*

### Comparing `volttron_dnp3_outstation-0.1.1a5/pyproject.toml` & `volttron_dnp3_outstation-0.1.1a6/pyproject.toml`
...
### Comparing `volttron_dnp3_outstation-0.1.1a5/src/dnp3_outstation/agent.py` & `volttron_dnp3_outstation-0.1.1a6/src/dnp3_outstation/agent.py`

 * *Files identical despite different names*

### Comparing `volttron_dnp3_outstation-0.1.1a5/src/vdnp3_outstation/run_volttron_dnp3_outstation_cli.py` & `volttron_dnp3_outstation-0.1.1a6/src/vdnp3_outstation/run_volttron_dnp3_outstation_cli.py`

 * *Files identical despite different names*

### Comparing `volttron_dnp3_outstation-0.1.1a5/setup.py` & `volttron_dnp3_outstation-0.1.1a6/setup.py`
...
@@ -7,22 +7,22 @@
 packages = \
 ['dnp3_outstation', 'vdnp3_outstation']
...
+['dnp3-python>=0.2.3b3,<0.3.0', 'volttron>=10.0.2rc0']
...
+install_requires = \ ['dnp3-python>=0.2.3b3,<0.3.0', 'volttron>=10.0.2rc0']
...
+outstation', 'version': '0.1.1a6', 'description': 'A Volttron agent that acts
...
### Comparing `volttron_dnp3_outstation-0.1.1a5/PKG-INFO` & `volttron_dnp3_outstation-0.1.1a6/PKG-INFO`
...
-Requires-Dist: dnp3-python (>=0.2.3b3)
...
+Metadata-Version: 2.1 Name: volttron-dnp3-outstation Version: 0.1.1a6 Summary:
...
+Requires-Dist: dnp3-python (>=0.2.3b3,<0.3.0) Requires-Dist: volttron
+(>=10.0.2rc0) Project-URL: Bug Tracker, https://github.com/eclipse-volttron/
+volttron-dnp3-outstation/issues Project-URL: Repository, https://github.com/
+eclipse-volttron/volttron-dnp3-outstation Description-Content-Type: text/
+markdown # volttron-dnp3-outstation [![Eclipse VOLTTRONâ¢](https://
+img.shields.io/badge/Eclips%20VOLTTRON--red.svg)](https://
...
+3.11-blue.svg) [![Pytests](https://github.com/eclipse-volttron/volttron-dnp3-
+outstation/actions/workflows/run-tests.yml/badge.svg)](https://github.com/
+eclipse-volttron/volttron-dnp3-outstation/actions/workflows/run-tests.yml) [!
+[pypi version](https://img.shields.io/pypi/v/volttron-dnp3-outstation.svg)]
+(https://pypi.org/project/volttron-dnp3-outstation/) Distributed Network
...
+the steps to install and configure a DNP3 agent. Note that it uses default
