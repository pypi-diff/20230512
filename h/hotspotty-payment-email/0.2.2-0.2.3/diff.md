# Comparing `tmp/hotspotty_payment_email-0.2.2.tar.gz` & `tmp/hotspotty_payment_email-0.2.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hotspotty_payment_email-0.2.2.tar", max compression
+gzip compressed data, was "hotspotty_payment_email-0.2.3.tar", max compression
```

## Comparing `hotspotty_payment_email-0.2.2.tar` & `hotspotty_payment_email-0.2.3.tar`

### file list

```diff
@@ -1,6 +1,6 @@
--rw-r--r--   0        0        0     4055 2023-05-12 15:07:11.864812 hotspotty_payment_email-0.2.2/README.md
--rw-r--r--   0        0        0        0 2023-05-10 02:24:31.545585 hotspotty_payment_email-0.2.2/hotspotty-payment-email/__init__.py
--rw-r--r--   0        0        0     5152 2023-05-12 15:37:47.652713 hotspotty_payment_email-0.2.2/hotspotty-payment-email/entry.py
--rw-r--r--   0        0        0      865 2023-05-12 15:44:05.561116 hotspotty_payment_email-0.2.2/pyproject.toml
--rw-r--r--   0        0        0     5392 1970-01-01 00:00:00.000000 hotspotty_payment_email-0.2.2/setup.py
--rw-r--r--   0        0        0     5030 1970-01-01 00:00:00.000000 hotspotty_payment_email-0.2.2/PKG-INFO
+-rw-r--r--   0        0        0     4055 2023-05-12 15:07:11.864812 hotspotty_payment_email-0.2.3/README.md
+-rw-r--r--   0        0        0        0 2023-05-10 02:24:31.545585 hotspotty_payment_email-0.2.3/hotspotty-payment-email/__init__.py
+-rw-r--r--   0        0        0     5152 2023-05-12 15:37:47.652713 hotspotty_payment_email-0.2.3/hotspotty-payment-email/entry.py
+-rw-r--r--   0        0        0      841 2023-05-12 15:46:12.497627 hotspotty_payment_email-0.2.3/pyproject.toml
+-rw-r--r--   0        0        0     5344 1970-01-01 00:00:00.000000 hotspotty_payment_email-0.2.3/setup.py
+-rw-r--r--   0        0        0     5030 1970-01-01 00:00:00.000000 hotspotty_payment_email-0.2.3/PKG-INFO
```

### Comparing `hotspotty_payment_email-0.2.2/README.md` & `hotspotty_payment_email-0.2.3/README.md`

 * *Files identical despite different names*

### Comparing `hotspotty_payment_email-0.2.2/hotspotty-payment-email/entry.py` & `hotspotty_payment_email-0.2.3/hotspotty-payment-email/entry.py`

 * *Files identical despite different names*

### Comparing `hotspotty_payment_email-0.2.2/pyproject.toml` & `hotspotty_payment_email-0.2.3/pyproject.toml`
...
### Comparing `hotspotty_payment_email-0.2.2/setup.py` & `hotspotty_payment_email-0.2.3/setup.py`
...
### Comparing `hotspotty_payment_email-0.2.2/PKG-INFO` & `hotspotty_payment_email-0.2.3/PKG-INFO`
