# Comparing `tmp/stix_shifter_modules_qradar_perf_test-5.2.1-py2.py3-none-any.whl.zip` & `tmp/stix_shifter_modules_qradar_perf_test-5.2.1.dev814-py2.py3-none-any.whl.zip`
