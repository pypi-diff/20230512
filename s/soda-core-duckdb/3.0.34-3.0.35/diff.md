# Comparing `tmp/soda-core-duckdb-3.0.34.tar.gz` & `tmp/soda-core-duckdb-3.0.35.tar.gz`
...
## Comparing `soda-core-duckdb-3.0.34.tar` & `soda-core-duckdb-3.0.35.tar`
...
### Comparing `soda-core-duckdb-3.0.34/setup.py` & `soda-core-duckdb-3.0.35/setup.py`
...
### Comparing `soda-core-duckdb-3.0.34/soda/data_sources/duckdb_data_source.py` & `soda-core-duckdb-3.0.35/soda/data_sources/duckdb_data_source.py`

 * *Files identical despite different names*

### Comparing `soda-core-duckdb-3.0.34/tests/test_duckdb.py` & `soda-core-duckdb-3.0.35/tests/test_duckdb.py`
