# Comparing `tmp/soda-core-duckdb-3.0.36.tar.gz` & `tmp/soda-core-duckdb-3.0.37.tar.gz`
...
## Comparing `soda-core-duckdb-3.0.36.tar` & `soda-core-duckdb-3.0.37.tar`
...
### Comparing `soda-core-duckdb-3.0.36/setup.py` & `soda-core-duckdb-3.0.37/setup.py`
...
### Comparing `soda-core-duckdb-3.0.36/soda/data_sources/duckdb_data_source.py` & `soda-core-duckdb-3.0.37/soda/data_sources/duckdb_data_source.py`

 * *Files identical despite different names*

### Comparing `soda-core-duckdb-3.0.36/tests/test_duckdb.py` & `soda-core-duckdb-3.0.37/tests/test_duckdb.py`
