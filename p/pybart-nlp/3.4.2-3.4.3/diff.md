# Comparing `tmp/pybart-nlp-3.4.2.tar.gz` & `tmp/pybart-nlp-3.4.3.tar.gz`
...
+gzip compressed data, was "pybart-nlp-3.4.3.tar", last modified: Fri May 12 06:49:38 2023, max compression
```

## Comparing `pybart-nlp-3.4.2.tar` & `pybart-nlp-3.4.3.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-12 06:49:38.336635 pybart-nlp-3.4.3/
+-rw-r--r--   0 runner    (1001) docker     (123)    11356 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     8544 2023-05-12 06:49:38.336635 pybart-nlp-3.4.3/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     8065 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-12 06:49:38.336635 pybart-nlp-3.4.3/pybart/
+-rw-r--r--   0 runner    (1001) docker     (123)       34 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7314 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/api.py
+-rw-r--r--   0 runner    (1001) docker     (123)    13824 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/conllu_wrapper.py
+-rw-r--r--   0 runner    (1001) docker     (123)    10695 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/constraints.py
+-rw-r--r--   0 runner    (1001) docker     (123)    90095 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/converter.py
+-rw-r--r--   0 runner    (1001) docker     (123)     5756 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/graph_token.py
+-rw-r--r--   0 runner    (1001) docker     (123)    17717 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/matcher.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4792 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/pybart/spacy_wrapper.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-12 06:49:38.336635 pybart-nlp-3.4.3/pybart_nlp.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     8544 2023-05-12 06:49:38.000000 pybart-nlp-3.4.3/pybart_nlp.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      326 2023-05-12 06:49:38.000000 pybart-nlp-3.4.3/pybart_nlp.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-12 06:49:38.000000 pybart-nlp-3.4.3/pybart_nlp.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        7 2023-05-12 06:49:38.000000 pybart-nlp-3.4.3/pybart_nlp.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-12 06:49:38.336635 pybart-nlp-3.4.3/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)      695 2023-05-12 06:49:25.000000 pybart-nlp-3.4.3/setup.py
```

### Comparing `pybart-nlp-3.4.2/LICENSE` & `pybart-nlp-3.4.3/LICENSE`

 * *Files identical despite different names*

### Comparing `pybart-nlp-3.4.2/PKG-INFO` & `pybart-nlp-3.4.3/PKG-INFO`
...
+Metadata-Version: 2.1 Name: pybart-nlp Version: 3.4.3 Summary: python converter
...
### Comparing `pybart-nlp-3.4.2/README.md` & `pybart-nlp-3.4.3/README.md`

 * *Files identical despite different names*

### Comparing `pybart-nlp-3.4.2/pybart/api.py` & `pybart-nlp-3.4.3/pybart/api.py`

 * *Files identical despite different names*

### Comparing `pybart-nlp-3.4.2/pybart/conllu_wrapper.py` & `pybart-nlp-3.4.3/pybart/conllu_wrapper.py`

 * *Files identical despite different names*

### Comparing `pybart-nlp-3.4.2/pybart/constraints.py` & `pybart-nlp-3.4.3/pybart/constraints.py`

 * *Files identical despite different names*

### Comparing `pybart-nlp-3.4.2/pybart/converter.py` & `pybart-nlp-3.4.3/pybart/converter.py`
...
### Comparing `pybart-nlp-3.4.2/pybart/graph_token.py` & `pybart-nlp-3.4.3/pybart/graph_token.py`
...
### Comparing `pybart-nlp-3.4.2/pybart/matcher.py` & `pybart-nlp-3.4.3/pybart/matcher.py`

 * *Files identical despite different names*

### Comparing `pybart-nlp-3.4.2/pybart/spacy_wrapper.py` & `pybart-nlp-3.4.3/pybart/spacy_wrapper.py`

 * *Files identical despite different names*

### Comparing `pybart-nlp-3.4.2/pybart_nlp.egg-info/PKG-INFO` & `pybart-nlp-3.4.3/pybart_nlp.egg-info/PKG-INFO`
...
### Comparing `pybart-nlp-3.4.2/setup.py` & `pybart-nlp-3.4.3/setup.py`
