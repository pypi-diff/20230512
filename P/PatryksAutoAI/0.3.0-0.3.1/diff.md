# Comparing `tmp/PatryksAutoAI-0.3.0.tar.gz` & `tmp/PatryksAutoAI-0.3.1.tar.gz`
...
### Comparing `PatryksAutoAI-0.3.0/PatryksAutoAI.egg-info/SOURCES.txt` & `PatryksAutoAI-0.3.1/PatryksAutoAI.egg-info/SOURCES.txt`
